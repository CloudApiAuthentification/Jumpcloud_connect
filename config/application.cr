...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Jumpcloud Connect web application."
  #
  #
  ...
  #
  # settings.secret_key_base= f3pLnDIFIqDVWMfFpxrj-Sa8e4j8xPDNbr3YF_rTKRI
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("jumpcloud_connect.log", "w"))
  #
  #
end
